...
function fillSummary() {
    ...
    var html =
        '<table class="summaryTable" style="width:100%; border-collapse: collapse;">' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Name</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + name + '</td></tr>' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Phone</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + phone + '</td></tr>' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Email</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + email + '</td></tr>' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Condition</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + disease + '</td></tr>' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Doctor</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + doctor + '</td></tr>' +
        '<tr class="summaryRow" style="border-bottom: 1px solid #ddd;"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Date</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + date + '</td></tr>' +
        '<tr class="summaryRow"><td class="summaryLabel" style="padding: 10px 0; font-weight: bold; color: #555; text-align: left;">Time</td><td class="summaryValue" style="padding: 10px 0; text-align: right; color: #1a252f;">' + time + '</td></tr>' +
        '</table>';
